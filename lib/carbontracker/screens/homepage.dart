...
import 'package:greenlivinghub/carbontracker/main-carbon.dart';
                ...
                children: [
                  ...
                  Text(
                    getCarbonFootprint().isAvg()
                        ? "You are in the Pakistani average, try to lower your consumption!"
                        : "You are below the Pakistani average!",
                    style: GoogleFonts.montserrat(
                      fontSize: 16,
                    ),
                  ),
